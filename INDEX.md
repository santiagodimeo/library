...
- [Catastrophic misinterpretation](domains/biology/psychology-behavior/catastrophic-misinterpretation.md) — panic and health anxiety run on reading benign sensations as catastrophe, and muscle relaxation measurably worsens panic outcomes (iOR 0.59)
- [Intrusive thoughts and appraisal](domains/biology/psychology-behavior/intrusive-thoughts-and-appraisal.md) — ≥90% of people have them, so the appraisal and the neutralizing response are the disorder, and the content targets the person's firmest values
